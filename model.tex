...
Cerberus allocates burst buffer to each job with regard to its use cases
...
Cerberus coordinates three queues and makes scheduling decisions according to job requirements in each queue with the objective to maximize job performance and system utilization.
