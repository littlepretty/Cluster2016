...
In the Trinity architecture, PFS is mounted by all the compute nodes,
...
\textit{by utilizing burst buffer nodes,
both the job-level and system-level performance can be significantly improved.
The execution of 99\% jobs will be expedited, 
...
\subsection{Cerberus Versus FCFS Three-Phase Scheduling}
...
%===========XY===============
Cerberus can adopt various algorithms when scheduling jobs in each queue. 
...
In the meanwhile, system throughput is boosted by as much as 23.87\%.
