...
\subsection{Q1: Is Burst Buffer Helpful?}
...
\subsection{Q2: Does Demand Granularity Matter?}
...
\subsection{Q3: Is Optimization Profitable?}
...
Algorithm~\ref{Alg:MaxBB} %Recursion~\ref{Equ:MaxTransferDataRecursion}.
For jobs in $Q_R$, Cerberus makes scheduling decision
based on the solution given by Algorithm~\ref{Alg:MaxCPU}. %Recursion~\ref{Equ:MaxProductRecursion}.
