...
\begin{itemize}
        \item \textbf{Q1}: Does the use of burst buffer 
                improve both system and job performance?
        \item \textbf{Q2}: What is the benefit of using three phase scheduling? 
        \item \textbf{Q3}: Can dynamic programming based optimization
...
according to solution given by \equref{Equ:MaxTransferDataRecursion};
...
As a result, Cerberus, according to \equref{Equ:MaxProductRecursion},
