...
%=============XY==============
In this section, we compare the overall performance on burst buffer enabled system
...
are significantly reduced, 272,741 and 376,026 seconds respectively.
\NOTE{Replace the legend in Fig4,5. 1-Phase IO with Direct IO,
Cerberus with BB-enabled}
...
\NOTE{Change legend/term to 1-phase-1d, 3-phase-1d, and 3-phase-3d. 
For both 3-phase-1d, and 3-phase-3d, Cerberus is used for job scheduling}

In this section we validate our 3-phase model by answering question Q2.
...
thus encouraging users to provide detailed burst buffer demand in each phase for her job.
...
%===========XY===============
In this section we answer question Q3 by showing that
