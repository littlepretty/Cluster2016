...
\begin{itemize}
        ...
        \item \textbf{Q2}: Will job demand on burst buffer affect Cerberus?
                Why bother to divide the job execution into 3 phases?
        \item \textbf{Q3}: Can dynamic programming based optimization
                make Cerberus even better?
\end{itemize}
We integrate Cerberus into our newly developed event-driven simulator, BBSim, and evaluate Cerberus agaist the traditional FCFS/EASY backfilling scheduler.
...
are significantly reduced, 272,741 and 376,026 seconds respectively.
\NOTE{replace the legend in Fig4,5. 1-Phase IO->Direct IO, Cerberus->BB-enabled}
