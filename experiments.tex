...
\NOTE{The upper bounds of time spent in the input queue is 
2,500 seconds for both 3-Phase-1D and 3-Phase-3D modeled jobs.}\TODO{Can't get this from Fig5b}
...
\begin{figure*}[htp]
        ...
        \caption{ Cerberus v.s. FCFS \TODO{change the legend: ``optimized Cerberus" to ``Cerberus"; ``FCFS Cerberus" to ``FCFS". move the avg legend to top}}
