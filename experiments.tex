...
The upper bounds of time spent in the input queue is 
...
\begin{figure*}[htp]
        ...
        %}
        %~
        \subfloat[Job Waiting Running Time] {
...
Compared with the FCFS Cerberus, \textit{the Optimized Cerberus achieves about 23.87\% higher average throughput}
