...
However, traditional batch schedulers have not embraced the full potential of burst buffer technology in practice. 
...
demonstrate that
1) compared to non-burst-buffer systems, Cerberus accelerates the execution pipeline of all tasks and reduces the response time of 99\% jobs;
2) on burst-buffer-enabled systems, the three-phase Cerberus and the burst buffer oriented optimization increase the average system throughput by 62.31\%.
\end{abstract}
