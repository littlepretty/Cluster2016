...
1) compared to non-burst-buffer systems, Cerberus accelerates the job execution and reduces the job response time;
2) our 3-phase design boosts the average system throughput by 62.31\%.
\end{abstract}
